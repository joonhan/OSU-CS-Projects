 ...
 *  If file exists, new text overwrites the old.. but doesn't clear the old if it's longer
*/
...
//large files must be sent using 1 send(); otherwise causes overwriting -- you're sending the msg
//from the same 65536 point each time... OR you can add an offset to the msg
